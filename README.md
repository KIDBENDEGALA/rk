...
local function CreateInterface()
    ...
    bgImage.Image = "rbxassetid://108426369175736"
...
local Window = Libary:MakeWindow({
    Title = "Dexter Hub 🏡 | Brookhaven RP ",
    SubTitle = "by:  deividTaxau10000 And erik  ",
    LoadText = "Carregando Dexter Hub",
    Flags = "DexterHub_Broookhaven"
})
Window:AddMinimizeButton({
    Button = { Image = "rbxassetid://108426369175736", BackgroundTransparency = 1 },
    Corner = { CornerRadius = UDim.new(35, 1) },
})

local InfoTab = Window:MakeTab({ Title = "Info", Icon = "rbxassetid://108426369175736" })



InfoTab:AddSection({ "Informações do Script" })
InfoTab:AddParagraph({ "Owner / Developer:", "  deividTaxau10000 and erik ." })
InfoTab:AddParagraph({ "Colaborações:", "Developerdevhub" })
InfoTab:AddParagraph({ "Você está usando:", "Dexter Brookhaven " })
...
Tab1:AddDiscordInvite({
    ...
    Logo = "rbxassetid://108426369175736",
    Invite = "https://discord.gg/6VRqjhqdf",
})
...
local Paragraph = Tab1:AddParagraph({"Criadores", "deividTaxau10000 \n ?????"})
  ...
  Tab1:AddButton({
    ...
    Callback = function()
      setclipboard("@trocasbrainrots000") -- Copia o @
      setclipboard("https://www.tiktok.com/@trocasbrainrots000?_t=ZM-90ZwFpsv7TU&_r=1") -- Copia o link também, se quiser só o @, remova esta linha
...
Tab:AddButton({
    Name = "Anti Som",
    Description = "DEU MO TRABALHO SE NÃO GOSTOU FAZ MELHOR AI DESGRAMA",
    Callback = function()
...
Tab:AddToggle({
    Name = "Anti-Lag",
    Description = "Deduplicação automática de ferramentas",
    Default = false,
    Callback = function(state)
        local Players = game:GetService("Players")
        local dedupLock = {}
...
Tab12:AddButton({
	Name = "Bug hammer",
	Callback = function()
	Description = "Causa bugs em jogadores",
		loadstring(game:HttpGet("https://raw.githubusercontent.com/267266273ffsfs/tooldobugkkj/refs/heads/main/Main.txt"))()
	end
})
